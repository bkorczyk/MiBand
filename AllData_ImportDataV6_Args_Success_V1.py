    ...
    async def activity_data_handler(self, sender, data):
        ...
        for i in range(num_samples):
            ...
            self.historical_data.append({
                ...
                "steps": steps,
                "heart_rate": hr,
                "distance_m": None,  # Brak w historycznych, dodane dla wyrównania
                "calories": None,    # Brak w historycznych
                "battery_level": None
            })
        ...
        try:
            async with BleakClient(self.mac) as client:
                ...
                try:
                    ...
                    await asyncio.wait_for(self.fetch_done.wait(), timeout=120)  # Wydłużony timeout
                except Exception as e:
